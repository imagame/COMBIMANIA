...
//#         g.drawString(GAMstr[i], GAMscrPxlLE+44, nivY, Graphics.TOP | Graphics.LEFT);
    ...
    else
    {
      ...
      if (MENid == 1 || MENid== 2 || MENid==3 ){
        ...
        offset = nivY+MENscrPxlOp*(MENsubop+2);
        ...
        g.drawString(GAMstr[MENval1 + offset], DEVscrPxlW / 2, nivY+MENscrPxlOp*2, Graphics.TOP | Graphics.HCENTER);
        ...
        g.drawString(GAMstr[32]+Integer.toString(MENval2+1), DEVscrPxlW / 2, nivY+MENscrPxlOp*3, Graphics.TOP | Graphics.HCENTER);
