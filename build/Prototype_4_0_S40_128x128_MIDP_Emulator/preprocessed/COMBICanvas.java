...
//#       int nY=nivY+3;
      ...
      for (int i = 0; i < 6; i++) {
        ...
        //#if CFGtamanyoGfx == 2
            //#if CFGfnt==0
//#             g.setClip(GAMwLe+44, nY, DEVw-24, MENhOp);
...
//#         g.drawString(GAMstr[32]+Integer.toString(MENval2+1), DEVw / 2, nivY+MENhOp*4, Graphics.TOP | Graphics.HCENTER);        
        ...
        if(babierto){
          if(MENid==3) //Dibujar Records en fases/Niveles abiertos
            HUD_DibTim(g,(short)(nivY+MENhOp*5), MENval1, MENval2); //.drawString(MENid==1?GAMstr[32]:GAMstr[33],
          else if (MENid==2)
            HUD_DibPun(g,(short)(nivY+MENhOp*5),(byte)1);
        }
