...
//#       nivY=nivY+3;
      ...
      //#if CFGtamanyoGfx == 2
//#         g.drawString(GAMstr[i], GAMscrPxlLE+44, nivY, Graphics.TOP | Graphics.LEFT);
       //#else
       g.drawString(GAMstr[i], DEVscrPxlW/2-30, nivY, Graphics.TOP | Graphics.LEFT);
       //#endif
        nivY += MENscrPxlOp;
      }
      //Dibujar icono combi
      HUD_DibImg(g, 15, MENscrPxlUP+4+MENscrPxlH1+2+MENop*MENscrPxlOp-1, 71);
    }
    else{
...
private void MEN_DibKeys(Graphics g, byte pid, boolean ptrans){
    ...
    MEN_DibRect(g,0,DEVscrPxlH-MENscrPxlDO,DEVscrPxlW,DEVscrPxlH, false, ptrans?0x40336699:0xFF336699, 0);
    g.setFont(fCnt);
    g.setColor(0xFFFFFF);
