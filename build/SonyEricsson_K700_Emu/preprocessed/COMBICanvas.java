...
//    //#else
    TXTiniPos = 0;
    TXTnumCars = TXT_ObtLongTextoFwd(LVL.HUDstr, 0, 56, 164);
...
//#     TXT_DibLinea(g,"Nivel: "+Integer.toString(LVL.idNiv+1),finX-2, iniY+4,1);
    ...
    TXT_DibLineasString(g, LVL.HUDstr, TXTiniPos, TXTnumCars, 6, iniY + NUMPIXELS_TILEY + 8, 164, -1);
    //#else
//#     //TXT_DibLineasString(g, LVL.HUDstr, TXTiniPos, TXTnumCars, DEVscrPxlW/2, iniY + NUMPIXELS_TILEY + 8, 164, 0);
//#     TXT_DibLineasString(g, LVL.HUDstr, TXTiniPos, TXTnumCars, 6, iniY + NUMPIXELS_TILEY + 8, 164, -1);
    //#endif
...
//#             TXTnumCars = TXT_ObtLongTextoFwd(LVL.HUDstr, TXTiniPos, 56, 164);
...
//#         if(TXTant)
//# 	{
//#           TXTnumCars = TXT_ObtLongTextoBwd(LVL.HUDstr, TXTiniPos-1, 56, 164);
//# 	  TXTiniPos -= TXTnumCars;
//# 	  TXTsig = true;
